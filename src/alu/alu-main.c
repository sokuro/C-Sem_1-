...
void print_alu(char *rega, char *regb, char * accumulator, char flags[])
{
  ...
  printf("Register A    %s            %3i              %3i\n",rega, sa, a);

  printf("Register B    %s            %3i              %3i\n",regb, sb, b);

  printf("accumulator   %s            %3i              %3i\n",accumulator, sacc, acc);

  printf("CSZO\n");
  printf("%c%c%c%c\n", getCarryflag(flags), getSignflag(flags), getZeroflag(flags), getOverflowflag(flags));
  printf("***********************\n");
}
